...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80011b:	56                   	push   %esi
  80011c:	50                   	push   %eax
  80011d:	68 40 28 80 00       	push   $0x802840
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800286:	0f be 80 63 28 80 00 	movsbl 0x802863(%eax),%eax
  80028d:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800451:	50                   	push   %eax
  800452:	68 7b 28 80 00       	push   $0x80287b
  800457:	53                   	push   %ebx
  800458:	56                   	push   %esi
  ...
  80048e:	b8 74 28 80 00       	mov    $0x802874,%eax
