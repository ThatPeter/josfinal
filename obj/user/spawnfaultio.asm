...
umain(int argc, char **argv)
{
  ...
  800067:	50                   	push   %eax
  800068:	68 06 28 80 00       	push   $0x802806
  80006d:	6a 09                	push   $0x9
  80006f:	68 20 28 80 00       	push   $0x802820
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80011a:	56                   	push   %esi
  80011b:	50                   	push   %eax
  80011c:	68 40 28 80 00       	push   $0x802840
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800285:	0f be 80 63 28 80 00 	movsbl 0x802863(%eax),%eax
  80028c:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800450:	50                   	push   %eax
  800451:	68 7b 28 80 00       	push   $0x80287b
  800456:	53                   	push   %ebx
  800457:	56                   	push   %esi
  ...
  80048d:	b8 74 28 80 00       	mov    $0x802874,%eax
