	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800212:	0f be 80 31 24 80 00 	movsbl 0x802431(%eax),%eax
  800219:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80030e:	ff 24 85 80 25 80 00 	jmp    *0x802580(,%eax,4)
  ...
  8003d2:	8b 14 85 e0 26 80 00 	mov    0x8026e0(,%eax,4),%edx
  8003d9:	85 d2                	test   %edx,%edx
  8003db:	75 18                	jne    8003f5 <vprintfmt+0x15a>
				printfmt(putch, putdat, "error %d", err);
  8003dd:	50                   	push   %eax
  8003de:	68 49 24 80 00       	push   $0x802449
  8003e3:	53                   	push   %ebx
  8003e4:	56                   	push   %esi
  ...
  8003f5:	52                   	push   %edx
  8003f6:	68 9d 28 80 00       	push   $0x80289d
  8003fb:	53                   	push   %ebx
  8003fc:	56                   	push   %esi
  ...
  80041a:	b8 42 24 80 00       	mov    $0x802442,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800a95:	68 3f 27 80 00       	push   $0x80273f
  800a9a:	6a 23                	push   $0x23
  800a9c:	68 5c 27 80 00       	push   $0x80275c
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b16:	68 3f 27 80 00       	push   $0x80273f
  800b1b:	6a 23                	push   $0x23
  800b1d:	68 5c 27 80 00       	push   $0x80275c
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800b58:	68 3f 27 80 00       	push   $0x80273f
  800b5d:	6a 23                	push   $0x23
  800b5f:	68 5c 27 80 00       	push   $0x80275c
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800b9a:	68 3f 27 80 00       	push   $0x80273f
  800b9f:	6a 23                	push   $0x23
  800ba1:	68 5c 27 80 00       	push   $0x80275c
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800bdc:	68 3f 27 80 00       	push   $0x80273f
  800be1:	6a 23                	push   $0x23
  800be3:	68 5c 27 80 00       	push   $0x80275c
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800c1e:	68 3f 27 80 00       	push   $0x80273f
  800c23:	6a 23                	push   $0x23
  800c25:	68 5c 27 80 00       	push   $0x80275c
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800c60:	68 3f 27 80 00       	push   $0x80273f
  800c65:	6a 23                	push   $0x23
  800c67:	68 5c 27 80 00       	push   $0x80275c
...
sys_ipc_recv(void *dstva)
{
  ...
  800cc4:	68 3f 27 80 00       	push   $0x80273f
  800cc9:	6a 23                	push   $0x23
  800ccb:	68 5c 27 80 00       	push   $0x80275c
...
pgfault(struct UTrapframe *utf)
{
  ...
  800d63:	68 6a 27 80 00       	push   $0x80276a
  800d68:	6a 1f                	push   $0x1f
  800d6a:	68 7a 27 80 00       	push   $0x80277a
  ...
  800d8c:	50                   	push   %eax
  800d8d:	68 85 27 80 00       	push   $0x802785
  800d92:	6a 2d                	push   $0x2d
  800d94:	68 7a 27 80 00       	push   $0x80277a
  ...
  800dd2:	79 12                	jns    800de6 <pgfault+0xa9>
		panic("sys page alloc failed %e", r);
  800dd4:	50                   	push   %eax
  800dd5:	68 85 27 80 00       	push   $0x802785
  800dda:	6a 34                	push   $0x34
  800ddc:	68 7a 27 80 00       	push   $0x80277a
  ...
  800dfa:	79 12                	jns    800e0e <pgfault+0xd1>
		panic("sys page alloc failed %e", r);
  800dfc:	50                   	push   %eax
  800dfd:	68 85 27 80 00       	push   $0x802785
  800e02:	6a 38                	push   $0x38
  800e04:	68 7a 27 80 00       	push   $0x80277a
...
sys_exofork(void)
{
  ...
  800e3a:	68 9e 27 80 00       	push   $0x80279e
  800e3f:	68 85 00 00 00       	push   $0x85
  800e44:	68 7a 27 80 00       	push   $0x80277a
  ...
  800eb7:	0f 84 e7 00 00 00    	je     800fa4 <fork+0x191>
{
  ...
  800ef6:	68 ac 27 80 00       	push   $0x8027ac
  800efb:	6a 55                	push   $0x55
  800efd:	68 7a 27 80 00       	push   $0x80277a
  ...
  800f3b:	68 ac 27 80 00       	push   $0x8027ac
  ...
  800f69:	68 ac 27 80 00       	push   $0x8027ac
  800f6e:	6a 60                	push   $0x60
  800f70:	68 7a 27 80 00       	push   $0x80277a
  ...
  800f93:	68 ac 27 80 00       	push   $0x8027ac
  800f98:	6a 65                	push   $0x65
  800f9a:	68 7a 27 80 00       	push   $0x80277a
...
queue_append(envid_t envid, struct waiting_queue* queue) 
{
  ...
  80104d:	79 15                	jns    801064 <queue_append+0x34>
		panic("%e\n", r);
  80104f:	50                   	push   %eax
  801050:	68 f2 27 80 00       	push   $0x8027f2
  801055:	68 d5 00 00 00       	push   $0xd5
  80105a:	68 7a 27 80 00       	push   $0x80277a
...
queue_pop(struct waiting_queue* queue) 
{
  ...
  8010b6:	68 c2 27 80 00       	push   $0x8027c2
  8010bb:	68 ec 00 00 00       	push   $0xec
  8010c0:	68 7a 27 80 00       	push   $0x80277a
...
xchg(volatile uint32_t *addr, uint32_t newval)
{
  ...
  801110:	79 15                	jns    801127 <mutex_lock+0x54>
			panic("%e\n", r);
  801112:	50                   	push   %eax
  801113:	68 f2 27 80 00       	push   $0x8027f2
  801118:	68 02 01 00 00       	push   $0x102
  80111d:	68 7a 27 80 00       	push   $0x80277a
...
mutex_unlock(struct Mutex* mtx)
{
  ...
  80116a:	79 1d                	jns    801189 <mutex_unlock+0x4e>
			panic("%e\n", r);
  80116c:	50                   	push   %eax
  80116d:	68 f2 27 80 00       	push   $0x8027f2
  801172:	68 16 01 00 00       	push   $0x116
  801177:	68 7a 27 80 00       	push   $0x80277a
...
{	int r;
  ...
  8011b5:	50                   	push   %eax
  8011b6:	68 dd 27 80 00       	push   $0x8027dd
  8011bb:	68 23 01 00 00       	push   $0x123
  8011c0:	68 7a 27 80 00       	push   $0x80277a
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  80130c:	ba 74 28 80 00       	mov    $0x802874,%edx
	int i;
	for (i = 0; devtab[i]; i++)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  80133a:	51                   	push   %ecx
  80133b:	50                   	push   %eax
  80133c:	68 f8 27 80 00       	push   $0x8027f8
...
read(int fdnum, void *buf, size_t n)
{
  ...
  801567:	53                   	push   %ebx
  801568:	50                   	push   %eax
  801569:	68 39 28 80 00       	push   $0x802839
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  80163f:	53                   	push   %ebx
  801640:	50                   	push   %eax
  801641:	68 55 28 80 00       	push   $0x802855
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8016f7:	53                   	push   %ebx
  8016f8:	50                   	push   %eax
  8016f9:	68 18 28 80 00       	push   $0x802818
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  80195a:	68 84 28 80 00       	push   $0x802884
  80195f:	68 8b 28 80 00       	push   $0x80288b
  801964:	6a 7c                	push   $0x7c
  801966:	68 a0 28 80 00       	push   $0x8028a0
  80196b:	e8 c6 05 00 00       	call   801f36 <_panic>
	assert(r <= PGSIZE);
  801970:	3d 00 10 00 00       	cmp    $0x1000,%eax
  801975:	7e 16                	jle    80198d <devfile_read+0x65>
  801977:	68 ab 28 80 00       	push   $0x8028ab
  80197c:	68 8b 28 80 00       	push   $0x80288b
  801981:	6a 7d                	push   $0x7d
  801983:	68 a0 28 80 00       	push   $0x8028a0
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801a66:	68 b7 28 80 00       	push   $0x8028b7
  801a6b:	53                   	push   %ebx
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  801b1f:	50                   	push   %eax
  801b20:	56                   	push   %esi
  801b21:	68 be 28 80 00       	push   $0x8028be
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801dc3:	68 d6 28 80 00       	push   $0x8028d6
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801f52:	56                   	push   %esi
  801f53:	50                   	push   %eax
  801f54:	68 e4 28 80 00       	push   $0x8028e4
  ...
  801f65:	e8 a9 e1 ff ff       	call   800113 <vcprintf>
	cprintf("\n");
  801f6a:	c7 04 24 db 27 80 00 	movl   $0x8027db,(%esp)
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  801fa1:	79 12                	jns    801fb5 <set_pgfault_handler+0x39>
			panic("%e\n", r);
  801fa3:	50                   	push   %eax
  801fa4:	68 f2 27 80 00       	push   $0x8027f2
  801fa9:	6a 23                	push   $0x23
  801fab:	68 08 29 80 00       	push   $0x802908
  ...
  801fd1:	79 12                	jns    801fe5 <set_pgfault_handler+0x69>
		panic("%e\n", r);
  801fd3:	50                   	push   %eax
  801fd4:	68 f2 27 80 00       	push   $0x8027f2
  801fd9:	6a 2c                	push   $0x2c
  801fdb:	68 08 29 80 00       	push   $0x802908
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  8020be:	50                   	push   %eax
  8020bf:	68 16 29 80 00       	push   $0x802916
  8020c4:	6a 47                	push   $0x47
  8020c6:	68 24 29 80 00       	push   $0x802924
