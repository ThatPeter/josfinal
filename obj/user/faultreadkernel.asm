...
xchg(volatile uint32_t *addr, uint32_t newval)
{
  ...
  801113:	79 15                	jns    80112a <mutex_lock+0x57>
			panic("%e\n", r);
  801115:	50                   	push   %eax
  801116:	68 f2 27 80 00       	push   $0x8027f2
  80111b:	68 02 01 00 00       	push   $0x102
  801120:	68 7a 27 80 00       	push   $0x80277a
...
mutex_unlock(struct Mutex* mtx)
{
  ...
  801176:	79 15                	jns    80118d <mutex_unlock+0x4d>
			panic("%e\n", r);
  801178:	50                   	push   %eax
  801179:	68 f2 27 80 00       	push   $0x8027f2
  80117e:	68 16 01 00 00       	push   $0x116
  801183:	68 7a 27 80 00       	push   $0x80277a
...
{	int r;
  ...
  8011b4:	50                   	push   %eax
  8011b5:	68 dd 27 80 00       	push   $0x8027dd
  8011ba:	68 22 01 00 00       	push   $0x122
  8011bf:	68 7a 27 80 00       	push   $0x80277a
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  801310:	ba 74 28 80 00       	mov    $0x802874,%edx
	int i;
	for (i = 0; devtab[i]; i++)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  80133e:	51                   	push   %ecx
  80133f:	50                   	push   %eax
  801340:	68 f8 27 80 00       	push   $0x8027f8
...
read(int fdnum, void *buf, size_t n)
{
  ...
  80156b:	53                   	push   %ebx
  80156c:	50                   	push   %eax
  80156d:	68 39 28 80 00       	push   $0x802839
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  801643:	53                   	push   %ebx
  801644:	50                   	push   %eax
  801645:	68 55 28 80 00       	push   $0x802855
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8016fb:	53                   	push   %ebx
  8016fc:	50                   	push   %eax
  8016fd:	68 18 28 80 00       	push   $0x802818
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  80195e:	68 84 28 80 00       	push   $0x802884
  801963:	68 8b 28 80 00       	push   $0x80288b
  801968:	6a 7c                	push   $0x7c
  80196a:	68 a0 28 80 00       	push   $0x8028a0
  80196f:	e8 c6 05 00 00       	call   801f3a <_panic>
	assert(r <= PGSIZE);
  801974:	3d 00 10 00 00       	cmp    $0x1000,%eax
  801979:	7e 16                	jle    801991 <devfile_read+0x65>
  80197b:	68 ab 28 80 00       	push   $0x8028ab
  801980:	68 8b 28 80 00       	push   $0x80288b
  801985:	6a 7d                	push   $0x7d
  801987:	68 a0 28 80 00       	push   $0x8028a0
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801a6a:	68 b7 28 80 00       	push   $0x8028b7
  801a6f:	53                   	push   %ebx
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  801b23:	50                   	push   %eax
  801b24:	56                   	push   %esi
  801b25:	68 be 28 80 00       	push   $0x8028be
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801dc7:	68 d6 28 80 00       	push   $0x8028d6
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801f56:	56                   	push   %esi
  801f57:	50                   	push   %eax
  801f58:	68 e4 28 80 00       	push   $0x8028e4
  ...
  801f69:	e8 a5 e1 ff ff       	call   800113 <vcprintf>
	cprintf("\n");
  801f6e:	c7 04 24 db 27 80 00 	movl   $0x8027db,(%esp)
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  801fa5:	79 12                	jns    801fb9 <set_pgfault_handler+0x39>
			panic("%e\n", r);
  801fa7:	50                   	push   %eax
  801fa8:	68 f2 27 80 00       	push   $0x8027f2
  801fad:	6a 23                	push   $0x23
  801faf:	68 08 29 80 00       	push   $0x802908
  ...
  801fd5:	79 12                	jns    801fe9 <set_pgfault_handler+0x69>
		panic("%e\n", r);
  801fd7:	50                   	push   %eax
  801fd8:	68 f2 27 80 00       	push   $0x8027f2
  801fdd:	6a 2c                	push   $0x2c
  801fdf:	68 08 29 80 00       	push   $0x802908
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  8020c2:	50                   	push   %eax
  8020c3:	68 16 29 80 00       	push   $0x802916
