...
libmain(int argc, char **argv)
{
  ...
  80006b:	50                   	push   %eax
  80006c:	68 88 1e 80 00       	push   $0x801e88
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80024f:	0f be 80 b1 1e 80 00 	movsbl 0x801eb1(%eax),%eax
  800256:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80034b:	ff 24 85 00 20 80 00 	jmp    *0x802000(,%eax,4)
  ...
  80040f:	8b 14 85 60 21 80 00 	mov    0x802160(,%eax,4),%edx
  800416:	85 d2                	test   %edx,%edx
  800418:	75 18                	jne    800432 <vprintfmt+0x15a>
				printfmt(putch, putdat, "error %d", err);
  80041a:	50                   	push   %eax
  80041b:	68 c9 1e 80 00       	push   $0x801ec9
  800420:	53                   	push   %ebx
  800421:	56                   	push   %esi
  ...
  800432:	52                   	push   %edx
  800433:	68 91 22 80 00       	push   $0x802291
  800438:	53                   	push   %ebx
  800439:	56                   	push   %esi
  ...
  800457:	b8 c2 1e 80 00       	mov    $0x801ec2,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800ad2:	68 bf 21 80 00       	push   $0x8021bf
  800ad7:	6a 23                	push   $0x23
  800ad9:	68 dc 21 80 00       	push   $0x8021dc
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b53:	68 bf 21 80 00       	push   $0x8021bf
  800b58:	6a 23                	push   $0x23
  800b5a:	68 dc 21 80 00       	push   $0x8021dc
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800b95:	68 bf 21 80 00       	push   $0x8021bf
  800b9a:	6a 23                	push   $0x23
  800b9c:	68 dc 21 80 00       	push   $0x8021dc
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800bd7:	68 bf 21 80 00       	push   $0x8021bf
  800bdc:	6a 23                	push   $0x23
  800bde:	68 dc 21 80 00       	push   $0x8021dc
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c19:	68 bf 21 80 00       	push   $0x8021bf
  800c1e:	6a 23                	push   $0x23
  800c20:	68 dc 21 80 00       	push   $0x8021dc
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800c5b:	68 bf 21 80 00       	push   $0x8021bf
  800c60:	6a 23                	push   $0x23
  800c62:	68 dc 21 80 00       	push   $0x8021dc
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800c9d:	68 bf 21 80 00       	push   $0x8021bf
  800ca2:	6a 23                	push   $0x23
  800ca4:	68 dc 21 80 00       	push   $0x8021dc
...
sys_ipc_recv(void *dstva)
{
  ...
  800d01:	68 bf 21 80 00       	push   $0x8021bf
  800d06:	6a 23                	push   $0x23
  800d08:	68 dc 21 80 00       	push   $0x8021dc
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800e0f:	ba 68 22 80 00       	mov    $0x802268,%edx
	int i;
	for (i = 0; devtab[i]; i++)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800e3a:	51                   	push   %ecx
  800e3b:	50                   	push   %eax
  800e3c:	68 ec 21 80 00       	push   $0x8021ec
...
read(int fdnum, void *buf, size_t n)
{
  ...
  801064:	53                   	push   %ebx
  801065:	50                   	push   %eax
  801066:	68 2d 22 80 00       	push   $0x80222d
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  801139:	53                   	push   %ebx
  80113a:	50                   	push   %eax
  80113b:	68 49 22 80 00       	push   $0x802249
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8011ee:	53                   	push   %ebx
  8011ef:	50                   	push   %eax
  8011f0:	68 0c 22 80 00       	push   $0x80220c
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  801451:	68 78 22 80 00       	push   $0x802278
  801456:	68 7f 22 80 00       	push   $0x80227f
  80145b:	6a 7c                	push   $0x7c
  80145d:	68 94 22 80 00       	push   $0x802294
  801462:	e8 bd 05 00 00       	call   801a24 <_panic>
	assert(r <= PGSIZE);
  801467:	3d 00 10 00 00       	cmp    $0x1000,%eax
  80146c:	7e 16                	jle    801484 <devfile_read+0x65>
  80146e:	68 9f 22 80 00       	push   $0x80229f
  801473:	68 7f 22 80 00       	push   $0x80227f
  801478:	6a 7d                	push   $0x7d
  80147a:	68 94 22 80 00       	push   $0x802294
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  80155d:	68 ab 22 80 00       	push   $0x8022ab
  801562:	53                   	push   %ebx
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  80160d:	50                   	push   %eax
  80160e:	56                   	push   %esi
  80160f:	68 b2 22 80 00       	push   $0x8022b2
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8018b1:	68 ca 22 80 00       	push   $0x8022ca
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801a40:	56                   	push   %esi
  801a41:	50                   	push   %eax
  801a42:	68 d8 22 80 00       	push   $0x8022d8
  ...
  801a53:	e8 f8 e6 ff ff       	call   800150 <vcprintf>
	cprintf("\n");
  801a58:	c7 04 24 c3 22 80 00 	movl   $0x8022c3,(%esp)
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801b17:	50                   	push   %eax
  801b18:	68 fc 22 80 00       	push   $0x8022fc
  801b1d:	6a 47                	push   $0x47
  801b1f:	68 0a 23 80 00       	push   $0x80230a
