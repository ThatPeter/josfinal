	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800213:	0f be 80 f1 21 80 00 	movsbl 0x8021f1(%eax),%eax
  80021a:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80030f:	ff 24 85 40 23 80 00 	jmp    *0x802340(,%eax,4)
  ...
  8003d3:	8b 14 85 a0 24 80 00 	mov    0x8024a0(,%eax,4),%edx
  8003da:	85 d2                	test   %edx,%edx
  8003dc:	75 18                	jne    8003f6 <vprintfmt+0x15a>
				printfmt(putch, putdat, "error %d", err);
  8003de:	50                   	push   %eax
  8003df:	68 09 22 80 00       	push   $0x802209
  8003e4:	53                   	push   %ebx
  8003e5:	56                   	push   %esi
  ...
  8003f6:	52                   	push   %edx
  8003f7:	68 4d 26 80 00       	push   $0x80264d
  8003fc:	53                   	push   %ebx
  8003fd:	56                   	push   %esi
  ...
  80041b:	b8 02 22 80 00       	mov    $0x802202,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800a96:	68 ff 24 80 00       	push   $0x8024ff
  800a9b:	6a 23                	push   $0x23
  800a9d:	68 1c 25 80 00       	push   $0x80251c
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b17:	68 ff 24 80 00       	push   $0x8024ff
  800b1c:	6a 23                	push   $0x23
  800b1e:	68 1c 25 80 00       	push   $0x80251c
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800b59:	68 ff 24 80 00       	push   $0x8024ff
  800b5e:	6a 23                	push   $0x23
  800b60:	68 1c 25 80 00       	push   $0x80251c
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800b9b:	68 ff 24 80 00       	push   $0x8024ff
  800ba0:	6a 23                	push   $0x23
  800ba2:	68 1c 25 80 00       	push   $0x80251c
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800bdd:	68 ff 24 80 00       	push   $0x8024ff
  800be2:	6a 23                	push   $0x23
  800be4:	68 1c 25 80 00       	push   $0x80251c
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800c1f:	68 ff 24 80 00       	push   $0x8024ff
  800c24:	6a 23                	push   $0x23
  800c26:	68 1c 25 80 00       	push   $0x80251c
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800c61:	68 ff 24 80 00       	push   $0x8024ff
  800c66:	6a 23                	push   $0x23
  800c68:	68 1c 25 80 00       	push   $0x80251c
...
pgfault(struct UTrapframe *utf)
{
  ...
  800d44:	68 2a 25 80 00       	push   $0x80252a
  800d49:	6a 1e                	push   $0x1e
  800d4b:	68 3a 25 80 00       	push   $0x80253a
  ...
  800d6d:	50                   	push   %eax
  800d6e:	68 45 25 80 00       	push   $0x802545
  800d73:	6a 2c                	push   $0x2c
  800d75:	68 3a 25 80 00       	push   $0x80253a
  ...
  800db3:	79 12                	jns    800dc7 <pgfault+0xa9>
		panic("sys page alloc failed %e", r);
  800db5:	50                   	push   %eax
  800db6:	68 45 25 80 00       	push   $0x802545
  800dbb:	6a 33                	push   $0x33
  800dbd:	68 3a 25 80 00       	push   $0x80253a
  ...
  800ddb:	79 12                	jns    800def <pgfault+0xd1>
		panic("sys page alloc failed %e", r);
  800ddd:	50                   	push   %eax
  800dde:	68 45 25 80 00       	push   $0x802545
  800de3:	6a 37                	push   $0x37
  800de5:	68 3a 25 80 00       	push   $0x80253a
...
sys_exofork(void)
{
  ...
  800e1b:	68 5e 25 80 00       	push   $0x80255e
  800e20:	68 84 00 00 00       	push   $0x84
  800e25:	68 3a 25 80 00       	push   $0x80253a
  ...
  800e99:	0f 84 e7 00 00 00    	je     800f86 <fork+0x192>
{
  ...
  800ed8:	68 6c 25 80 00       	push   $0x80256c
  800edd:	6a 54                	push   $0x54
  800edf:	68 3a 25 80 00       	push   $0x80253a
  ...
  800f1d:	68 6c 25 80 00       	push   $0x80256c
  800f22:	6a 5b                	push   $0x5b
  800f24:	68 3a 25 80 00       	push   $0x80253a
  ...
  800f4b:	68 6c 25 80 00       	push   $0x80256c
  800f50:	6a 5f                	push   $0x5f
  800f52:	68 3a 25 80 00       	push   $0x80253a
  ...
  800f75:	68 6c 25 80 00       	push   $0x80256c
  800f7a:	6a 64                	push   $0x64
  800f7c:	68 3a 25 80 00       	push   $0x80253a
...
thread_create(void (*func)())
{
  ...
  800fe0:	53                   	push   %ebx
  800fe1:	68 84 25 80 00       	push   $0x802584
  ...
  800ffc:	53                   	push   %ebx
  800ffd:	68 84 25 80 00       	push   $0x802584
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  8010e5:	ba 24 26 80 00       	mov    $0x802624,%edx
	int i;
	for (i = 0; devtab[i]; i++)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  801110:	51                   	push   %ecx
  801111:	50                   	push   %eax
  801112:	68 a8 25 80 00       	push   $0x8025a8
...
read(int fdnum, void *buf, size_t n)
{
  ...
  80133a:	53                   	push   %ebx
  80133b:	50                   	push   %eax
  80133c:	68 e9 25 80 00       	push   $0x8025e9
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  80140f:	53                   	push   %ebx
  801410:	50                   	push   %eax
  801411:	68 05 26 80 00       	push   $0x802605
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8014c4:	53                   	push   %ebx
  8014c5:	50                   	push   %eax
  8014c6:	68 c8 25 80 00       	push   $0x8025c8
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  801727:	68 34 26 80 00       	push   $0x802634
  80172c:	68 3b 26 80 00       	push   $0x80263b
  801731:	6a 7c                	push   $0x7c
  801733:	68 50 26 80 00       	push   $0x802650
  801738:	e8 bd 05 00 00       	call   801cfa <_panic>
	assert(r <= PGSIZE);
  80173d:	3d 00 10 00 00       	cmp    $0x1000,%eax
  801742:	7e 16                	jle    80175a <devfile_read+0x65>
  801744:	68 5b 26 80 00       	push   $0x80265b
  801749:	68 3b 26 80 00       	push   $0x80263b
  80174e:	6a 7d                	push   $0x7d
  801750:	68 50 26 80 00       	push   $0x802650
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801833:	68 67 26 80 00       	push   $0x802667
  801838:	53                   	push   %ebx
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  8018e3:	50                   	push   %eax
  8018e4:	56                   	push   %esi
  8018e5:	68 6e 26 80 00       	push   $0x80266e
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801b87:	68 86 26 80 00       	push   $0x802686
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801d16:	56                   	push   %esi
  801d17:	50                   	push   %eax
  801d18:	68 94 26 80 00       	push   $0x802694
  ...
  801d29:	e8 e6 e3 ff ff       	call   800114 <vcprintf>
	cprintf("\n");
  801d2e:	c7 04 24 7f 26 80 00 	movl   $0x80267f,(%esp)
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  801d65:	79 12                	jns    801d79 <set_pgfault_handler+0x39>
			panic("%e\n", r);
  801d67:	50                   	push   %eax
  801d68:	68 b8 26 80 00       	push   $0x8026b8
  801d6d:	6a 23                	push   $0x23
  801d6f:	68 bc 26 80 00       	push   $0x8026bc
  ...
  801d95:	79 12                	jns    801da9 <set_pgfault_handler+0x69>
		panic("%e\n", r);
  801d97:	50                   	push   %eax
  801d98:	68 b8 26 80 00       	push   $0x8026b8
  801d9d:	6a 2c                	push   $0x2c
  801d9f:	68 bc 26 80 00       	push   $0x8026bc
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801e7f:	50                   	push   %eax
  801e80:	68 ca 26 80 00       	push   $0x8026ca
  801e85:	6a 47                	push   $0x47
  801e87:	68 d8 26 80 00       	push   $0x8026d8
