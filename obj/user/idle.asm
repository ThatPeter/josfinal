...
umain(int argc, char **argv)
{
  ...
  800036:	83 ec 08             	sub    $0x8,%esp
	binaryname = "idle";
  800039:	c7 05 00 30 80 00 20 	movl   $0x801e20,0x803000
  800040:	1e 80 00 
	...
	while (1) {
		sys_yield();
  800043:	e8 47 01 00 00       	call   80018f <sys_yield>
...
sys_env_destroy(envid_t envid)
{
  ...
  800157:	68 2f 1e 80 00       	push   $0x801e2f
  80015c:	6a 23                	push   $0x23
  80015e:	68 4c 1e 80 00       	push   $0x801e4c
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8001d8:	68 2f 1e 80 00       	push   $0x801e2f
  8001dd:	6a 23                	push   $0x23
  8001df:	68 4c 1e 80 00       	push   $0x801e4c
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  80021a:	68 2f 1e 80 00       	push   $0x801e2f
  80021f:	6a 23                	push   $0x23
  800221:	68 4c 1e 80 00       	push   $0x801e4c
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  80025c:	68 2f 1e 80 00       	push   $0x801e2f
  800261:	6a 23                	push   $0x23
  800263:	68 4c 1e 80 00       	push   $0x801e4c
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  80029e:	68 2f 1e 80 00       	push   $0x801e2f
  8002a3:	6a 23                	push   $0x23
  8002a5:	68 4c 1e 80 00       	push   $0x801e4c
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  8002e0:	68 2f 1e 80 00       	push   $0x801e2f
  8002e5:	6a 23                	push   $0x23
  8002e7:	68 4c 1e 80 00       	push   $0x801e4c
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800322:	68 2f 1e 80 00       	push   $0x801e2f
  800327:	6a 23                	push   $0x23
  800329:	68 4c 1e 80 00       	push   $0x801e4c
...
sys_ipc_recv(void *dstva)
{
  ...
  800386:	68 2f 1e 80 00       	push   $0x801e2f
  80038b:	6a 23                	push   $0x23
  80038d:	68 4c 1e 80 00       	push   $0x801e4c
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800474:	ba d8 1e 80 00       	mov    $0x801ed8,%edx
	int i;
	for (i = 0; devtab[i]; i++)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  80049f:	51                   	push   %ecx
  8004a0:	50                   	push   %eax
  8004a1:	68 5c 1e 80 00       	push   $0x801e5c
...
read(int fdnum, void *buf, size_t n)
{
  ...
  8006c9:	53                   	push   %ebx
  8006ca:	50                   	push   %eax
  8006cb:	68 9d 1e 80 00       	push   $0x801e9d
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  80079e:	53                   	push   %ebx
  80079f:	50                   	push   %eax
  8007a0:	68 b9 1e 80 00       	push   $0x801eb9
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  800853:	53                   	push   %ebx
  800854:	50                   	push   %eax
  800855:	68 7c 1e 80 00       	push   $0x801e7c
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  800ab6:	68 e8 1e 80 00       	push   $0x801ee8
  800abb:	68 ef 1e 80 00       	push   $0x801eef
  800ac0:	6a 7c                	push   $0x7c
  800ac2:	68 04 1f 80 00       	push   $0x801f04
  800ac7:	e8 bd 05 00 00       	call   801089 <_panic>
	assert(r <= PGSIZE);
  800acc:	3d 00 10 00 00       	cmp    $0x1000,%eax
  800ad1:	7e 16                	jle    800ae9 <devfile_read+0x65>
  800ad3:	68 0f 1f 80 00       	push   $0x801f0f
  800ad8:	68 ef 1e 80 00       	push   $0x801eef
  800add:	6a 7d                	push   $0x7d
  800adf:	68 04 1f 80 00       	push   $0x801f04
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800bc2:	68 1b 1f 80 00       	push   $0x801f1b
  800bc7:	53                   	push   %ebx
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  800c72:	50                   	push   %eax
  800c73:	56                   	push   %esi
  800c74:	68 22 1f 80 00       	push   $0x801f22
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800f16:	68 3a 1f 80 00       	push   $0x801f3a
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8010a5:	56                   	push   %esi
  8010a6:	50                   	push   %eax
  8010a7:	68 48 1f 80 00       	push   $0x801f48
  ...
  8010b8:	e8 54 00 00 00       	call   801111 <vcprintf>
	cprintf("\n");
  8010bd:	c7 04 24 33 1f 80 00 	movl   $0x801f33,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  801210:	0f be 80 6b 1f 80 00 	movsbl 0x801f6b(%eax),%eax
  801217:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8013db:	50                   	push   %eax
  8013dc:	68 83 1f 80 00       	push   $0x801f83
  8013e1:	53                   	push   %ebx
  8013e2:	56                   	push   %esi
  ...
  8013f3:	52                   	push   %edx
  8013f4:	68 01 1f 80 00       	push   $0x801f01
  8013f9:	53                   	push   %ebx
  8013fa:	56                   	push   %esi
  ...
  801418:	b8 7c 1f 80 00       	mov    $0x801f7c,%eax
