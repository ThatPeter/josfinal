...
umain(int argc, char **argv)
{
  ...
  800036:	83 ec 08             	sub    $0x8,%esp
	binaryname = "idle";
  800039:	c7 05 00 30 80 00 c0 	movl   $0x8021c0,0x803000
  800040:	21 80 00 
	...
	while (1) {
		sys_yield();
  800043:	e8 23 01 00 00       	call   80016b <sys_yield>
...
sys_env_destroy(envid_t envid)
{
  ...
  800133:	68 cf 21 80 00       	push   $0x8021cf
  800138:	6a 23                	push   $0x23
  80013a:	68 ec 21 80 00       	push   $0x8021ec
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8001b4:	68 cf 21 80 00       	push   $0x8021cf
  8001b9:	6a 23                	push   $0x23
  8001bb:	68 ec 21 80 00       	push   $0x8021ec
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001f6:	68 cf 21 80 00       	push   $0x8021cf
  8001fb:	6a 23                	push   $0x23
  8001fd:	68 ec 21 80 00       	push   $0x8021ec
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800238:	68 cf 21 80 00       	push   $0x8021cf
  80023d:	6a 23                	push   $0x23
  80023f:	68 ec 21 80 00       	push   $0x8021ec
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  80027a:	68 cf 21 80 00       	push   $0x8021cf
  80027f:	6a 23                	push   $0x23
  800281:	68 ec 21 80 00       	push   $0x8021ec
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  8002bc:	68 cf 21 80 00       	push   $0x8021cf
  8002c1:	6a 23                	push   $0x23
  8002c3:	68 ec 21 80 00       	push   $0x8021ec
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8002fe:	68 cf 21 80 00       	push   $0x8021cf
  800303:	6a 23                	push   $0x23
  800305:	68 ec 21 80 00       	push   $0x8021ec
...
sys_ipc_recv(void *dstva)
{
  ...
  800362:	68 cf 21 80 00       	push   $0x8021cf
  800367:	6a 23                	push   $0x23
  800369:	68 ec 21 80 00       	push   $0x8021ec
...
pgfault(struct UTrapframe *utf)
{
  ...
  8003e1:	68 fa 21 80 00       	push   $0x8021fa
  8003e6:	6a 1e                	push   $0x1e
  8003e8:	68 0a 22 80 00       	push   $0x80220a
  ...
  80040a:	50                   	push   %eax
  80040b:	68 15 22 80 00       	push   $0x802215
  800410:	6a 2c                	push   $0x2c
  800412:	68 0a 22 80 00       	push   $0x80220a
  ...
  800450:	79 12                	jns    800464 <pgfault+0xa9>
		panic("sys page alloc failed %e", r);
  800452:	50                   	push   %eax
  800453:	68 15 22 80 00       	push   $0x802215
  800458:	6a 33                	push   $0x33
  80045a:	68 0a 22 80 00       	push   $0x80220a
  ...
  800478:	79 12                	jns    80048c <pgfault+0xd1>
		panic("sys page alloc failed %e", r);
  80047a:	50                   	push   %eax
  80047b:	68 15 22 80 00       	push   $0x802215
  800480:	6a 37                	push   $0x37
  800482:	68 0a 22 80 00       	push   $0x80220a
...
sys_exofork(void)
{
  ...
  8004b8:	68 2e 22 80 00       	push   $0x80222e
  8004bd:	68 84 00 00 00       	push   $0x84
  8004c2:	68 0a 22 80 00       	push   $0x80220a
  ...
  800536:	0f 84 e7 00 00 00    	je     800623 <fork+0x192>
{
  ...
  800575:	68 3c 22 80 00       	push   $0x80223c
  80057a:	6a 54                	push   $0x54
  80057c:	68 0a 22 80 00       	push   $0x80220a
  ...
  8005ba:	68 3c 22 80 00       	push   $0x80223c
  8005bf:	6a 5b                	push   $0x5b
  8005c1:	68 0a 22 80 00       	push   $0x80220a
  ...
  8005e8:	68 3c 22 80 00       	push   $0x80223c
  8005ed:	6a 5f                	push   $0x5f
  8005ef:	68 0a 22 80 00       	push   $0x80220a
  ...
  800612:	68 3c 22 80 00       	push   $0x80223c
  800617:	6a 64                	push   $0x64
  800619:	68 0a 22 80 00       	push   $0x80220a
...
thread_create(void (*func)())
{
  ...
  80067d:	53                   	push   %ebx
  80067e:	68 54 22 80 00       	push   $0x802254
  ...
  800699:	53                   	push   %ebx
  80069a:	68 54 22 80 00       	push   $0x802254
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800782:	ba f4 22 80 00       	mov    $0x8022f4,%edx
	int i;
	for (i = 0; devtab[i]; i++)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  8007ad:	51                   	push   %ecx
  8007ae:	50                   	push   %eax
  8007af:	68 78 22 80 00       	push   $0x802278
...
read(int fdnum, void *buf, size_t n)
{
  ...
  8009d7:	53                   	push   %ebx
  8009d8:	50                   	push   %eax
  8009d9:	68 b9 22 80 00       	push   $0x8022b9
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  800aac:	53                   	push   %ebx
  800aad:	50                   	push   %eax
  800aae:	68 d5 22 80 00       	push   $0x8022d5
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  800b61:	53                   	push   %ebx
  800b62:	50                   	push   %eax
  800b63:	68 98 22 80 00       	push   $0x802298
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  800dc4:	68 04 23 80 00       	push   $0x802304
  800dc9:	68 0b 23 80 00       	push   $0x80230b
  800dce:	6a 7c                	push   $0x7c
  800dd0:	68 20 23 80 00       	push   $0x802320
  800dd5:	e8 bd 05 00 00       	call   801397 <_panic>
	assert(r <= PGSIZE);
  800dda:	3d 00 10 00 00       	cmp    $0x1000,%eax
  800ddf:	7e 16                	jle    800df7 <devfile_read+0x65>
  800de1:	68 2b 23 80 00       	push   $0x80232b
  800de6:	68 0b 23 80 00       	push   $0x80230b
  800deb:	6a 7d                	push   $0x7d
  800ded:	68 20 23 80 00       	push   $0x802320
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800ed0:	68 37 23 80 00       	push   $0x802337
  800ed5:	53                   	push   %ebx
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  800f80:	50                   	push   %eax
  800f81:	56                   	push   %esi
  800f82:	68 3e 23 80 00       	push   $0x80233e
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801224:	68 56 23 80 00       	push   $0x802356
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8013b3:	56                   	push   %esi
  8013b4:	50                   	push   %eax
  8013b5:	68 64 23 80 00       	push   $0x802364
  ...
  8013c6:	e8 54 00 00 00       	call   80141f <vcprintf>
	cprintf("\n");
  8013cb:	c7 04 24 4f 23 80 00 	movl   $0x80234f,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80151e:	0f be 80 87 23 80 00 	movsbl 0x802387(%eax),%eax
  801525:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8016e9:	50                   	push   %eax
  8016ea:	68 9f 23 80 00       	push   $0x80239f
  8016ef:	53                   	push   %ebx
  8016f0:	56                   	push   %esi
  ...
  801701:	52                   	push   %edx
  801702:	68 1d 23 80 00       	push   $0x80231d
  801707:	53                   	push   %ebx
  801708:	56                   	push   %esi
  ...
  801726:	b8 98 23 80 00       	mov    $0x802398,%eax
