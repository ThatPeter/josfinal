...
xchg(volatile uint32_t *addr, uint32_t newval)
{
  ...
  8007b0:	79 15                	jns    8007c7 <mutex_lock+0x57>
			panic("%e\n", r);
  8007b2:	50                   	push   %eax
  8007b3:	68 c2 24 80 00       	push   $0x8024c2
  8007b8:	68 02 01 00 00       	push   $0x102
  8007bd:	68 4a 24 80 00       	push   $0x80244a
...
mutex_unlock(struct Mutex* mtx)
{
  ...
  800813:	79 15                	jns    80082a <mutex_unlock+0x4d>
			panic("%e\n", r);
  800815:	50                   	push   %eax
  800816:	68 c2 24 80 00       	push   $0x8024c2
  80081b:	68 16 01 00 00       	push   $0x116
  800820:	68 4a 24 80 00       	push   $0x80244a
...
{	int r;
  ...
  800851:	50                   	push   %eax
  800852:	68 ad 24 80 00       	push   $0x8024ad
  800857:	68 22 01 00 00       	push   $0x122
  80085c:	68 4a 24 80 00       	push   $0x80244a
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  8009ad:	ba 44 25 80 00       	mov    $0x802544,%edx
	int i;
	for (i = 0; devtab[i]; i++)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  8009db:	51                   	push   %ecx
  8009dc:	50                   	push   %eax
  8009dd:	68 c8 24 80 00       	push   $0x8024c8
...
read(int fdnum, void *buf, size_t n)
{
  ...
  800c08:	53                   	push   %ebx
  800c09:	50                   	push   %eax
  800c0a:	68 09 25 80 00       	push   $0x802509
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  800ce0:	53                   	push   %ebx
  800ce1:	50                   	push   %eax
  800ce2:	68 25 25 80 00       	push   $0x802525
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  800d98:	53                   	push   %ebx
  800d99:	50                   	push   %eax
  800d9a:	68 e8 24 80 00       	push   $0x8024e8
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  800ffb:	68 54 25 80 00       	push   $0x802554
  801000:	68 5b 25 80 00       	push   $0x80255b
  801005:	6a 7c                	push   $0x7c
  801007:	68 70 25 80 00       	push   $0x802570
  80100c:	e8 c6 05 00 00       	call   8015d7 <_panic>
	assert(r <= PGSIZE);
  801011:	3d 00 10 00 00       	cmp    $0x1000,%eax
  801016:	7e 16                	jle    80102e <devfile_read+0x65>
  801018:	68 7b 25 80 00       	push   $0x80257b
  80101d:	68 5b 25 80 00       	push   $0x80255b
  801022:	6a 7d                	push   $0x7d
  801024:	68 70 25 80 00       	push   $0x802570
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801107:	68 87 25 80 00       	push   $0x802587
  80110c:	53                   	push   %ebx
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  8011c0:	50                   	push   %eax
  8011c1:	56                   	push   %esi
  8011c2:	68 8e 25 80 00       	push   $0x80258e
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801464:	68 a6 25 80 00       	push   $0x8025a6
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8015f3:	56                   	push   %esi
  8015f4:	50                   	push   %eax
  8015f5:	68 b4 25 80 00       	push   $0x8025b4
  ...
  801606:	e8 54 00 00 00       	call   80165f <vcprintf>
	cprintf("\n");
  80160b:	c7 04 24 ab 24 80 00 	movl   $0x8024ab,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80175e:	0f be 80 d7 25 80 00 	movsbl 0x8025d7(%eax),%eax
  801765:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  801929:	50                   	push   %eax
  80192a:	68 ef 25 80 00       	push   $0x8025ef
  80192f:	53                   	push   %ebx
  801930:	56                   	push   %esi
  ...
  801941:	52                   	push   %edx
  801942:	68 6d 25 80 00       	push   $0x80256d
  801947:	53                   	push   %ebx
  801948:	56                   	push   %esi
  ...
  801966:	b8 e8 25 80 00       	mov    $0x8025e8,%eax
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  801fa1:	79 12                	jns    801fb5 <set_pgfault_handler+0x39>
			panic("%e\n", r);
  801fa3:	50                   	push   %eax
  801fa4:	68 c2 24 80 00       	push   $0x8024c2
  ...
  801fd1:	79 12                	jns    801fe5 <set_pgfault_handler+0x69>
		panic("%e\n", r);
  801fd3:	50                   	push   %eax
  801fd4:	68 c2 24 80 00       	push   $0x8024c2
