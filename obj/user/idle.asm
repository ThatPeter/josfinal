...
sys_env_destroy(envid_t envid)
{
  ...
  800132:	68 cf 21 80 00       	push   $0x8021cf
  800137:	6a 23                	push   $0x23
  800139:	68 ec 21 80 00       	push   $0x8021ec
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8001b3:	68 cf 21 80 00       	push   $0x8021cf
  8001b8:	6a 23                	push   $0x23
  8001ba:	68 ec 21 80 00       	push   $0x8021ec
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001f5:	68 cf 21 80 00       	push   $0x8021cf
  8001fa:	6a 23                	push   $0x23
  8001fc:	68 ec 21 80 00       	push   $0x8021ec
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800237:	68 cf 21 80 00       	push   $0x8021cf
  80023c:	6a 23                	push   $0x23
  80023e:	68 ec 21 80 00       	push   $0x8021ec
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800279:	68 cf 21 80 00       	push   $0x8021cf
  80027e:	6a 23                	push   $0x23
  800280:	68 ec 21 80 00       	push   $0x8021ec
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  8002bb:	68 cf 21 80 00       	push   $0x8021cf
  8002c0:	6a 23                	push   $0x23
  8002c2:	68 ec 21 80 00       	push   $0x8021ec
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8002fd:	68 cf 21 80 00       	push   $0x8021cf
  800302:	6a 23                	push   $0x23
  800304:	68 ec 21 80 00       	push   $0x8021ec
...
sys_ipc_recv(void *dstva)
{
  ...
  800361:	68 cf 21 80 00       	push   $0x8021cf
  800366:	6a 23                	push   $0x23
  800368:	68 ec 21 80 00       	push   $0x8021ec
...
pgfault(struct UTrapframe *utf)
{
  ...
  8003e0:	68 fa 21 80 00       	push   $0x8021fa
  8003e5:	6a 1e                	push   $0x1e
  8003e7:	68 0a 22 80 00       	push   $0x80220a
  ...
  800409:	50                   	push   %eax
  80040a:	68 15 22 80 00       	push   $0x802215
  80040f:	6a 2c                	push   $0x2c
  800411:	68 0a 22 80 00       	push   $0x80220a
  ...
  80044f:	79 12                	jns    800463 <pgfault+0xa9>
		panic("sys page alloc failed %e", r);
  800451:	50                   	push   %eax
  800452:	68 15 22 80 00       	push   $0x802215
  800457:	6a 33                	push   $0x33
  800459:	68 0a 22 80 00       	push   $0x80220a
  ...
  800477:	79 12                	jns    80048b <pgfault+0xd1>
		panic("sys page alloc failed %e", r);
  800479:	50                   	push   %eax
  80047a:	68 15 22 80 00       	push   $0x802215
  80047f:	6a 37                	push   $0x37
  800481:	68 0a 22 80 00       	push   $0x80220a
...
sys_exofork(void)
{
  ...
  8004b7:	68 2e 22 80 00       	push   $0x80222e
  8004bc:	68 84 00 00 00       	push   $0x84
  8004c1:	68 0a 22 80 00       	push   $0x80220a
  ...
  800534:	0f 84 e7 00 00 00    	je     800621 <fork+0x191>
{
  ...
  800573:	68 3c 22 80 00       	push   $0x80223c
  800578:	6a 54                	push   $0x54
  80057a:	68 0a 22 80 00       	push   $0x80220a
  ...
  8005b8:	68 3c 22 80 00       	push   $0x80223c
  8005bd:	6a 5b                	push   $0x5b
  8005bf:	68 0a 22 80 00       	push   $0x80220a
  ...
  8005e6:	68 3c 22 80 00       	push   $0x80223c
  8005eb:	6a 5f                	push   $0x5f
  8005ed:	68 0a 22 80 00       	push   $0x80220a
  ...
  800610:	68 3c 22 80 00       	push   $0x80223c
  800615:	6a 64                	push   $0x64
  800617:	68 0a 22 80 00       	push   $0x80220a
...
thread_create(void (*func)())
{
  ...
  80067e:	53                   	push   %ebx
  80067f:	68 54 22 80 00       	push   $0x802254
  ...
  80069a:	53                   	push   %ebx
  80069b:	68 54 22 80 00       	push   $0x802254
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800783:	ba f4 22 80 00       	mov    $0x8022f4,%edx
	int i;
	for (i = 0; devtab[i]; i++)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  8007ae:	51                   	push   %ecx
  8007af:	50                   	push   %eax
  8007b0:	68 78 22 80 00       	push   $0x802278
...
read(int fdnum, void *buf, size_t n)
{
  ...
  8009d8:	53                   	push   %ebx
  8009d9:	50                   	push   %eax
  8009da:	68 b9 22 80 00       	push   $0x8022b9
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  800aad:	53                   	push   %ebx
  800aae:	50                   	push   %eax
  800aaf:	68 d5 22 80 00       	push   $0x8022d5
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  800b62:	53                   	push   %ebx
  800b63:	50                   	push   %eax
  800b64:	68 98 22 80 00       	push   $0x802298
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  800dc5:	68 04 23 80 00       	push   $0x802304
  800dca:	68 0b 23 80 00       	push   $0x80230b
  800dcf:	6a 7c                	push   $0x7c
  800dd1:	68 20 23 80 00       	push   $0x802320
  800dd6:	e8 c6 05 00 00       	call   8013a1 <_panic>
	assert(r <= PGSIZE);
  800ddb:	3d 00 10 00 00       	cmp    $0x1000,%eax
  800de0:	7e 16                	jle    800df8 <devfile_read+0x65>
  800de2:	68 2b 23 80 00       	push   $0x80232b
  800de7:	68 0b 23 80 00       	push   $0x80230b
  800dec:	6a 7d                	push   $0x7d
  800dee:	68 20 23 80 00       	push   $0x802320
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800ed1:	68 37 23 80 00       	push   $0x802337
  800ed6:	53                   	push   %ebx
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  800f8a:	50                   	push   %eax
  800f8b:	56                   	push   %esi
  800f8c:	68 3e 23 80 00       	push   $0x80233e
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  80122e:	68 56 23 80 00       	push   $0x802356
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8013bd:	56                   	push   %esi
  8013be:	50                   	push   %eax
  8013bf:	68 64 23 80 00       	push   $0x802364
  ...
  8013d0:	e8 54 00 00 00       	call   801429 <vcprintf>
	cprintf("\n");
  8013d5:	c7 04 24 4f 23 80 00 	movl   $0x80234f,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  801528:	0f be 80 87 23 80 00 	movsbl 0x802387(%eax),%eax
  80152f:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8016f3:	50                   	push   %eax
  8016f4:	68 9f 23 80 00       	push   $0x80239f
  8016f9:	53                   	push   %ebx
  8016fa:	56                   	push   %esi
  ...
  80170b:	52                   	push   %edx
  80170c:	68 1d 23 80 00       	push   $0x80231d
  801711:	53                   	push   %ebx
  801712:	56                   	push   %esi
  ...
  801730:	b8 98 23 80 00       	mov    $0x802398,%eax
