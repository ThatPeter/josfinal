...
exit(void)
{
  ...
  8000aa:	83 ec 08             	sub    $0x8,%esp
	close_all();
  8000ad:	e8 e8 09 00 00       	call   800a9a <close_all>
	sys_env_destroy(0);
...
sys_env_destroy(envid_t envid)
{
  ...
  800132:	e8 94 14 00 00       	call   8015cb <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8001b3:	e8 13 14 00 00       	call   8015cb <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001f5:	e8 d1 13 00 00       	call   8015cb <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800237:	e8 8f 13 00 00       	call   8015cb <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800279:	e8 4d 13 00 00       	call   8015cb <_panic>
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  8002bb:	e8 0b 13 00 00       	call   8015cb <_panic>
int
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8002fd:	e8 c9 12 00 00       	call   8015cb <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800361:	e8 65 12 00 00       	call   8015cb <_panic>
...
pgfault(struct UTrapframe *utf)
{
  ...
  800400:	e8 c6 11 00 00       	call   8015cb <_panic>
	// Hint:
  ...
  80042a:	e8 9c 11 00 00       	call   8015cb <_panic>
	}
  ...
  800443:	e8 db 19 00 00       	call   801e23 <memcpy>
  ...
  800472:	e8 54 11 00 00       	call   8015cb <_panic>
	}
  ...
  80049a:	e8 2c 11 00 00       	call   8015cb <_panic>
	}
...
fork(void)
{
  ...
  8004b2:	e8 b9 1a 00 00       	call   801f70 <set_pgfault_handler>
...
sys_exofork(void)
{
  ...
  8004da:	e8 ec 10 00 00       	call   8015cb <_panic>
  ...
  800548:	0f 84 e7 00 00 00    	je     800635 <fork+0x191>
{
  ...
  800593:	e8 33 10 00 00       	call   8015cb <_panic>
		} 
	}	
  ...
  8005d8:	e8 ee 0f 00 00       	call   8015cb <_panic>
		}
  ...
  800606:	e8 c0 0f 00 00       	call   8015cb <_panic>
		}		
	} else { 
  ...
  800630:	e8 96 0f 00 00       	call   8015cb <_panic>
	}
...
queue_append(envid_t envid, struct waiting_queue* queue) 
{
  ...
  8006f0:	e8 d6 0e 00 00       	call   8015cb <_panic>
	}	
...
queue_pop(struct waiting_queue* queue) 
{
  ...
  800756:	e8 70 0e 00 00       	call   8015cb <_panic>
	}
...
xchg(volatile uint32_t *addr, uint32_t newval)
{
  ...
  80076c:	b8 01 00 00 00       	mov    $0x1,%eax
  800771:	f0 87 03             	lock xchg %eax,(%ebx)
	if ((xchg(&mtx->locked, 1) != 0) && mtx->queue->first == 0) {
  800774:	85 c0                	test   %eax,%eax
  800776:	74 4a                	je     8007c2 <mutex_lock+0x5e>
  800778:	8b 73 04             	mov    0x4(%ebx),%esi
  80077b:	83 3e 00             	cmpl   $0x0,(%esi)
  80077e:	75 42                	jne    8007c2 <mutex_lock+0x5e>
		queue_append(sys_getenvid(), mtx->queue);		
  800780:	e8 ba f9 ff ff       	call   80013f <sys_getenvid>
  800785:	83 ec 08             	sub    $0x8,%esp
  800788:	56                   	push   %esi
  800789:	50                   	push   %eax
  80078a:	e8 32 ff ff ff       	call   8006c1 <queue_append>
		int r = sys_env_set_status(sys_getenvid(), ENV_NOT_RUNNABLE);	
  80078f:	e8 ab f9 ff ff       	call   80013f <sys_getenvid>
  800794:	83 c4 08             	add    $0x8,%esp
  800797:	6a 04                	push   $0x4
  800799:	50                   	push   %eax
  80079a:	e8 a5 fa ff ff       	call   800244 <sys_env_set_status>

		if (r < 0) {
  80079f:	83 c4 10             	add    $0x10,%esp
  8007a2:	85 c0                	test   %eax,%eax
  8007a4:	79 15                	jns    8007bb <mutex_lock+0x57>
			panic("%e\n", r);
  8007a6:	50                   	push   %eax
  8007a7:	68 bd 24 80 00       	push   $0x8024bd
  8007ac:	68 02 01 00 00       	push   $0x102
  8007b1:	68 45 24 80 00       	push   $0x802445
  8007b6:	e8 10 0e 00 00       	call   8015cb <_panic>
		}
		sys_yield();
  8007bb:	e8 9e f9 ff ff       	call   80015e <sys_yield>
v pripade, ze sa vrati 0 a necaka nikto na mutex, nastavime vlastnika na terajsi env
v opacnom pripade sa appendne tento env na koniec zoznamu a nastavi sa na NOT RUNNABLE*/
void 
mutex_lock(struct Mutex* mtx)
{
	if ((xchg(&mtx->locked, 1) != 0) && mtx->queue->first == 0) {
  8007c0:	eb 08                	jmp    8007ca <mutex_lock+0x66>
		if (r < 0) {
			panic("%e\n", r);
		}
		sys_yield();
  ...
  8007c2:	e8 78 f9 ff ff       	call   80013f <sys_getenvid>
  8007c7:	89 43 08             	mov    %eax,0x8(%ebx)
	}
}
  8007ca:	8d 65 f8             	lea    -0x8(%ebp),%esp
  8007cd:	5b                   	pop    %ebx
  8007ce:	5e                   	pop    %esi
  8007cf:	5d                   	pop    %ebp
  8007d0:	c3                   	ret    

008007d1 <mutex_unlock>:
...
mutex_unlock(struct Mutex* mtx)
{
  ...
  8007e0:	f0 87 03             	lock xchg %eax,(%ebx)
	xchg(&mtx->locked, 0);
	
	if (mtx->queue->first != NULL) {
  8007e3:	8b 43 04             	mov    0x4(%ebx),%eax
  8007e6:	83 38 00             	cmpl   $0x0,(%eax)
  8007e9:	74 33                	je     80081e <mutex_unlock+0x4d>
		mtx->owner = queue_pop(mtx->queue);
  8007eb:	83 ec 0c             	sub    $0xc,%esp
  8007ee:	50                   	push   %eax
  8007ef:	e8 41 ff ff ff       	call   800735 <queue_pop>
  8007f4:	89 43 08             	mov    %eax,0x8(%ebx)
		int r = sys_env_set_status(mtx->owner, ENV_RUNNABLE);
  8007f7:	83 c4 08             	add    $0x8,%esp
  8007fa:	6a 02                	push   $0x2
  8007fc:	50                   	push   %eax
  8007fd:	e8 42 fa ff ff       	call   800244 <sys_env_set_status>
		if (r < 0) {
  800802:	83 c4 10             	add    $0x10,%esp
  800805:	85 c0                	test   %eax,%eax
  800807:	79 15                	jns    80081e <mutex_unlock+0x4d>
			panic("%e\n", r);
  800809:	50                   	push   %eax
  80080a:	68 bd 24 80 00       	push   $0x8024bd
  80080f:	68 16 01 00 00       	push   $0x116
  800814:	68 45 24 80 00       	push   $0x802445
  800819:	e8 ad 0d 00 00       	call   8015cb <_panic>
		}
	}
...
{	int r;
  ...
  80082d:	e8 0d f9 ff ff       	call   80013f <sys_getenvid>
  800832:	83 ec 04             	sub    $0x4,%esp
  800835:	6a 07                	push   $0x7
  800837:	53                   	push   %ebx
  800838:	50                   	push   %eax
  800839:	e8 3f f9 ff ff       	call   80017d <sys_page_alloc>
  80083e:	83 c4 10             	add    $0x10,%esp
  800841:	85 c0                	test   %eax,%eax
  800843:	79 15                	jns    80085a <mutex_init+0x37>
		panic("panic at mutex init: %e\n", r);
  800845:	50                   	push   %eax
  800846:	68 a8 24 80 00       	push   $0x8024a8
  80084b:	68 22 01 00 00       	push   $0x122
  800850:	68 45 24 80 00       	push   $0x802445
  800855:	e8 71 0d 00 00       	call   8015cb <_panic>
	}	
	mtx->locked = 0;
  80085a:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
	mtx->queue->first = NULL;
  800860:	8b 43 04             	mov    0x4(%ebx),%eax
  800863:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
	mtx->queue->last = NULL;
  800869:	8b 43 04             	mov    0x4(%ebx),%eax
  80086c:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
	mtx->owner = 0;
  800873:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
}
...
mutex_destroy(struct Mutex* mtx)
{
  ...
  800889:	eb 21                	jmp    8008ac <mutex_destroy+0x2d>
		sys_env_set_status(queue_pop(mtx->queue), ENV_RUNNABLE);
  80088b:	83 ec 0c             	sub    $0xc,%esp
  80088e:	50                   	push   %eax
  80088f:	e8 a1 fe ff ff       	call   800735 <queue_pop>
  800894:	83 c4 08             	add    $0x8,%esp
  800897:	6a 02                	push   $0x2
  800899:	50                   	push   %eax
  80089a:	e8 a5 f9 ff ff       	call   800244 <sys_env_set_status>
		mtx->queue->first = mtx->queue->first->next;
  80089f:	8b 43 04             	mov    0x4(%ebx),%eax
  8008a2:	8b 10                	mov    (%eax),%edx
  8008a4:	8b 52 04             	mov    0x4(%edx),%edx
...
mutex_destroy(struct Mutex* mtx)
{
  ...
  8008af:	83 38 00             	cmpl   $0x0,(%eax)
  8008b2:	75 d7                	jne    80088b <mutex_destroy+0xc>
		sys_env_set_status(queue_pop(mtx->queue), ENV_RUNNABLE);
		mtx->queue->first = mtx->queue->first->next;
	}
  ...
  8008be:	53                   	push   %ebx
  8008bf:	e8 aa 14 00 00       	call   801d6e <memset>
	mtx = NULL;
}
...
fd_close(struct Fd *fd, bool must_exist)
{
  ...
  800a5e:	e8 9f f7 ff ff       	call   800202 <sys_page_unmap>
	return r;
...
dup(int oldfdnum, int newfdnum)
{
  ...
  800b4a:	e8 71 f6 ff ff       	call   8001c0 <sys_page_map>
  ...
  800b76:	e8 45 f6 ff ff       	call   8001c0 <sys_page_map>
...
err:
  ...
  800b8c:	e8 71 f6 ff ff       	call   800202 <sys_page_unmap>
	sys_page_unmap(0, nva);
  800b91:	83 c4 08             	add    $0x8,%esp
  800b94:	ff 75 d4             	pushl  -0x2c(%ebp)
  800b97:	6a 00                	push   $0x0
  800b99:	e8 64 f6 ff ff       	call   800202 <sys_page_unmap>
	return r;
...
devpipe_close(struct Fd *fd)
{
  ...
  80113e:	e8 bf f0 ff ff       	call   800202 <sys_page_unmap>
  ...
  801151:	e8 ac f0 ff ff       	call   800202 <sys_page_unmap>
}
...
devpipe_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  8011f9:	75 48                	jne    801243 <devpipe_write+0x73>
			...
			sys_yield();
  8011fb:	e8 5e ef ff ff       	call   80015e <sys_yield>
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
devpipe_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  801281:	75 32                	jne    8012b5 <devpipe_read+0x65>
			...
			sys_yield();
  801283:	e8 d6 ee ff ff       	call   80015e <sys_yield>
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			thisenv->env_id, uvpt[PGNUM(p)], n, p->p_rpos, p->p_wpos);
...
pipe(int pfd[2])
{
  ...
  8012ed:	e8 8b ee ff ff       	call   80017d <sys_page_alloc>
  ...
  801325:	e8 53 ee ff ff       	call   80017d <sys_page_alloc>
  ...
  80134f:	e8 29 ee ff ff       	call   80017d <sys_page_alloc>
  ...
  801379:	e8 42 ee ff ff       	call   8001c0 <sys_page_map>
  ...
  8013e2:	e8 1b ee ff ff       	call   800202 <sys_page_unmap>
  ...
  8013f2:	e8 0b ee ff ff       	call   800202 <sys_page_unmap>
  ...
  801402:	e8 fb ed ff ff       	call   800202 <sys_page_unmap>
...
devcons_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  8014a6:	53                   	push   %ebx
  8014a7:	57                   	push   %edi
  8014a8:	e8 14 ec ff ff       	call   8000c1 <sys_cputs>
	int tot, m;
	char buf[128];
...
devcons_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  8014d2:	eb 05                	jmp    8014d9 <devcons_read+0x18>
	...
	while ((c = sys_cgetc()) == 0)
		sys_yield();
  8014d4:	e8 85 ec ff ff       	call   80015e <sys_yield>
	int c;
	...
	while ((c = sys_cgetc()) == 0)
  8014d9:	e8 01 ec ff ff       	call   8000df <sys_cgetc>
...
cputchar(int ch)
{
  ...
  80150f:	50                   	push   %eax
  801510:	e8 ac eb ff ff       	call   8000c1 <sys_cputs>
}
...
opencons(void)
{
  ...
  801596:	e8 e2 eb ff ff       	call   80017d <sys_page_alloc>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8015d9:	e8 61 eb ff ff       	call   80013f <sys_getenvid>
...
putch(int ch, struct printbuf *b)
{
  ...
  80163b:	50                   	push   %eax
  80163c:	e8 80 ea ff ff       	call   8000c1 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  801696:	50                   	push   %eax
  801697:	e8 25 ea ff ff       	call   8000c1 <sys_cputs>
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  801f8b:	e8 ed e1 ff ff       	call   80017d <sys_page_alloc>
				   PTE_W | PTE_U | PTE_P);
		if (r < 0) {
  ...
  801fbb:	e8 08 e3 ff ff       	call   8002c8 <sys_env_set_pgfault_upcall>
	if (r < 0) {
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  802019:	e8 0f e3 ff ff       	call   80032d <sys_ipc_recv>
  ...
  802026:	50                   	push   %eax
  802027:	e8 01 e3 ff ff       	call   80032d <sys_ipc_recv>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  80209a:	56                   	push   %esi
  80209b:	57                   	push   %edi
  80209c:	e8 69 e2 ff ff       	call   80030a <sys_ipc_try_send>
  ...
  8020c7:	75 07                	jne    8020d0 <ipc_send+0x56>
			sys_yield();
  8020c9:	e8 90 e0 ff ff       	call   80015e <sys_yield>
