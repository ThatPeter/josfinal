...
umain(int argc, char **argv)
{
  ...
  80006a:	50                   	push   %eax
  80006b:	68 64 28 80 00       	push   $0x802864
  800070:	6a 09                	push   $0x9
  800072:	68 7c 28 80 00       	push   $0x80287c
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80011d:	56                   	push   %esi
  80011e:	50                   	push   %eax
  80011f:	68 98 28 80 00       	push   $0x802898
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800288:	0f be 80 bb 28 80 00 	movsbl 0x8028bb(%eax),%eax
  80028f:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800453:	50                   	push   %eax
  800454:	68 d3 28 80 00       	push   $0x8028d3
  800459:	53                   	push   %ebx
  80045a:	56                   	push   %esi
  ...
  800490:	b8 cc 28 80 00       	mov    $0x8028cc,%eax
