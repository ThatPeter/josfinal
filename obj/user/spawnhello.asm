...
libmain(int argc, char **argv)
{
  ...
  800098:	50                   	push   %eax
  800099:	68 b0 24 80 00       	push   $0x8024b0
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800157:	56                   	push   %esi
  800158:	50                   	push   %eax
  800159:	68 dc 24 80 00       	push   $0x8024dc
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002c2:	0f be 80 ff 24 80 00 	movsbl 0x8024ff(%eax),%eax
  8002c9:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80048d:	50                   	push   %eax
  80048e:	68 17 25 80 00       	push   $0x802517
  800493:	53                   	push   %ebx
  800494:	56                   	push   %esi
  ...
  8004ca:	b8 10 25 80 00       	mov    $0x802510,%eax
