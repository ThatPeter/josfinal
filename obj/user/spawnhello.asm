...
umain(int argc, char **argv)
{
  ...
  80006a:	50                   	push   %eax
  80006b:	68 c4 2a 80 00       	push   $0x802ac4
  800070:	6a 09                	push   $0x9
  800072:	68 dc 2a 80 00       	push   $0x802adc
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80011d:	56                   	push   %esi
  80011e:	50                   	push   %eax
  80011f:	68 f8 2a 80 00       	push   $0x802af8
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800288:	0f be 80 1b 2b 80 00 	movsbl 0x802b1b(%eax),%eax
  80028f:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800453:	50                   	push   %eax
  800454:	68 33 2b 80 00       	push   $0x802b33
  800459:	53                   	push   %ebx
  80045a:	56                   	push   %esi
  ...
  800490:	b8 2c 2b 80 00       	mov    $0x802b2c,%eax
