	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800237:	0f be 80 48 1e 80 00 	movsbl 0x801e48(%eax),%eax
  80023e:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800333:	ff 24 85 80 1f 80 00 	jmp    *0x801f80(,%eax,4)
  ...
  8003f7:	8b 14 85 e0 20 80 00 	mov    0x8020e0(,%eax,4),%edx
  8003fe:	85 d2                	test   %edx,%edx
  800400:	75 18                	jne    80041a <vprintfmt+0x15a>
				printfmt(putch, putdat, "error %d", err);
  800402:	50                   	push   %eax
  800403:	68 60 1e 80 00       	push   $0x801e60
  800408:	53                   	push   %ebx
  800409:	56                   	push   %esi
  ...
  80041a:	52                   	push   %edx
  80041b:	68 11 22 80 00       	push   $0x802211
  800420:	53                   	push   %ebx
  800421:	56                   	push   %esi
  ...
  80043f:	b8 59 1e 80 00       	mov    $0x801e59,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800aba:	68 3f 21 80 00       	push   $0x80213f
  800abf:	6a 23                	push   $0x23
  800ac1:	68 5c 21 80 00       	push   $0x80215c
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b3b:	68 3f 21 80 00       	push   $0x80213f
  800b40:	6a 23                	push   $0x23
  800b42:	68 5c 21 80 00       	push   $0x80215c
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800b7d:	68 3f 21 80 00       	push   $0x80213f
  800b82:	6a 23                	push   $0x23
  800b84:	68 5c 21 80 00       	push   $0x80215c
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800bbf:	68 3f 21 80 00       	push   $0x80213f
  800bc4:	6a 23                	push   $0x23
  800bc6:	68 5c 21 80 00       	push   $0x80215c
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c01:	68 3f 21 80 00       	push   $0x80213f
  800c06:	6a 23                	push   $0x23
  800c08:	68 5c 21 80 00       	push   $0x80215c
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800c43:	68 3f 21 80 00       	push   $0x80213f
  800c48:	6a 23                	push   $0x23
  800c4a:	68 5c 21 80 00       	push   $0x80215c
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800c85:	68 3f 21 80 00       	push   $0x80213f
  800c8a:	6a 23                	push   $0x23
  800c8c:	68 5c 21 80 00       	push   $0x80215c
...
sys_ipc_recv(void *dstva)
{
  ...
  800ce9:	68 3f 21 80 00       	push   $0x80213f
  800cee:	6a 23                	push   $0x23
  800cf0:	68 5c 21 80 00       	push   $0x80215c
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800dd7:	ba e8 21 80 00       	mov    $0x8021e8,%edx
	int i;
	for (i = 0; devtab[i]; i++)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800e02:	51                   	push   %ecx
  800e03:	50                   	push   %eax
  800e04:	68 6c 21 80 00       	push   $0x80216c
...
read(int fdnum, void *buf, size_t n)
{
  ...
  80102c:	53                   	push   %ebx
  80102d:	50                   	push   %eax
  80102e:	68 ad 21 80 00       	push   $0x8021ad
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  801101:	53                   	push   %ebx
  801102:	50                   	push   %eax
  801103:	68 c9 21 80 00       	push   $0x8021c9
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8011b6:	53                   	push   %ebx
  8011b7:	50                   	push   %eax
  8011b8:	68 8c 21 80 00       	push   $0x80218c
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801525:	68 2b 22 80 00       	push   $0x80222b
  80152a:	53                   	push   %ebx
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  8015d5:	50                   	push   %eax
  8015d6:	56                   	push   %esi
  8015d7:	68 32 22 80 00       	push   $0x802232
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801879:	68 4a 22 80 00       	push   $0x80224a
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801a08:	56                   	push   %esi
  801a09:	50                   	push   %eax
  801a0a:	68 58 22 80 00       	push   $0x802258
  ...
  801a1b:	e8 18 e7 ff ff       	call   800138 <vcprintf>
	cprintf("\n");
  801a20:	c7 04 24 3c 1e 80 00 	movl   $0x801e3c,(%esp)
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801adc:	50                   	push   %eax
  801add:	68 7c 22 80 00       	push   $0x80227c
  801ae2:	6a 47                	push   $0x47
  801ae4:	68 8a 22 80 00       	push   $0x80228a
