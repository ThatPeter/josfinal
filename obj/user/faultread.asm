	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800212:	0f be 80 48 22 80 00 	movsbl 0x802248(%eax),%eax
  800219:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80030e:	ff 24 85 80 23 80 00 	jmp    *0x802380(,%eax,4)
  ...
  8003d2:	8b 14 85 e0 24 80 00 	mov    0x8024e0(,%eax,4),%edx
  8003d9:	85 d2                	test   %edx,%edx
  8003db:	75 18                	jne    8003f5 <vprintfmt+0x15a>
				printfmt(putch, putdat, "error %d", err);
  8003dd:	50                   	push   %eax
  8003de:	68 60 22 80 00       	push   $0x802260
  8003e3:	53                   	push   %ebx
  8003e4:	56                   	push   %esi
  ...
  8003f5:	52                   	push   %edx
  8003f6:	68 8d 26 80 00       	push   $0x80268d
  8003fb:	53                   	push   %ebx
  8003fc:	56                   	push   %esi
  ...
  80041a:	b8 59 22 80 00       	mov    $0x802259,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800a95:	68 3f 25 80 00       	push   $0x80253f
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b16:	68 3f 25 80 00       	push   $0x80253f
  800b1b:	6a 23                	push   $0x23
  800b1d:	68 5c 25 80 00       	push   $0x80255c
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800b58:	68 3f 25 80 00       	push   $0x80253f
  800b5d:	6a 23                	push   $0x23
  800b5f:	68 5c 25 80 00       	push   $0x80255c
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800b9a:	68 3f 25 80 00       	push   $0x80253f
  800b9f:	6a 23                	push   $0x23
  800ba1:	68 5c 25 80 00       	push   $0x80255c
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800bdc:	68 3f 25 80 00       	push   $0x80253f
  800be1:	6a 23                	push   $0x23
  800be3:	68 5c 25 80 00       	push   $0x80255c
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800c1e:	68 3f 25 80 00       	push   $0x80253f
  800c23:	6a 23                	push   $0x23
  800c25:	68 5c 25 80 00       	push   $0x80255c
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800c60:	68 3f 25 80 00       	push   $0x80253f
  800c65:	6a 23                	push   $0x23
  800c67:	68 5c 25 80 00       	push   $0x80255c
...
sys_ipc_recv(void *dstva)
{
  ...
  800cc4:	68 3f 25 80 00       	push   $0x80253f
  800cc9:	6a 23                	push   $0x23
  800ccb:	68 5c 25 80 00       	push   $0x80255c
...
pgfault(struct UTrapframe *utf)
{
  ...
  800d63:	68 6a 25 80 00       	push   $0x80256a
  800d68:	6a 1e                	push   $0x1e
  800d6a:	68 7a 25 80 00       	push   $0x80257a
  ...
  800d8c:	50                   	push   %eax
  800d8d:	68 85 25 80 00       	push   $0x802585
  800d92:	6a 2c                	push   $0x2c
  800d94:	68 7a 25 80 00       	push   $0x80257a
  ...
  800dd2:	79 12                	jns    800de6 <pgfault+0xa9>
		panic("sys page alloc failed %e", r);
  800dd4:	50                   	push   %eax
  800dd5:	68 85 25 80 00       	push   $0x802585
  800dda:	6a 33                	push   $0x33
  800ddc:	68 7a 25 80 00       	push   $0x80257a
  ...
  800dfa:	79 12                	jns    800e0e <pgfault+0xd1>
		panic("sys page alloc failed %e", r);
  800dfc:	50                   	push   %eax
  800dfd:	68 85 25 80 00       	push   $0x802585
  800e02:	6a 37                	push   $0x37
  800e04:	68 7a 25 80 00       	push   $0x80257a
...
sys_exofork(void)
{
  ...
  800e3a:	68 9e 25 80 00       	push   $0x80259e
  800e3f:	68 84 00 00 00       	push   $0x84
  800e44:	68 7a 25 80 00       	push   $0x80257a
  ...
  800eb7:	0f 84 e7 00 00 00    	je     800fa4 <fork+0x191>
{
  ...
  800ef6:	68 ac 25 80 00       	push   $0x8025ac
  800efb:	6a 54                	push   $0x54
  800efd:	68 7a 25 80 00       	push   $0x80257a
  ...
  800f3b:	68 ac 25 80 00       	push   $0x8025ac
  800f40:	6a 5b                	push   $0x5b
  800f42:	68 7a 25 80 00       	push   $0x80257a
  ...
  800f69:	68 ac 25 80 00       	push   $0x8025ac
  800f6e:	6a 5f                	push   $0x5f
  800f70:	68 7a 25 80 00       	push   $0x80257a
  ...
  800f93:	68 ac 25 80 00       	push   $0x8025ac
  800f98:	6a 64                	push   $0x64
  800f9a:	68 7a 25 80 00       	push   $0x80257a
...
thread_create(void (*func)())
{
  ...
  801001:	53                   	push   %ebx
  801002:	68 c4 25 80 00       	push   $0x8025c4
  ...
  80101d:	53                   	push   %ebx
  80101e:	68 c4 25 80 00       	push   $0x8025c4
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  80112c:	ba 64 26 80 00       	mov    $0x802664,%edx
	int i;
	for (i = 0; devtab[i]; i++)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  80115a:	51                   	push   %ecx
  80115b:	50                   	push   %eax
  80115c:	68 e8 25 80 00       	push   $0x8025e8
...
read(int fdnum, void *buf, size_t n)
{
  ...
  801387:	53                   	push   %ebx
  801388:	50                   	push   %eax
  801389:	68 29 26 80 00       	push   $0x802629
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  80145f:	53                   	push   %ebx
  801460:	50                   	push   %eax
  801461:	68 45 26 80 00       	push   $0x802645
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  801517:	53                   	push   %ebx
  801518:	50                   	push   %eax
  801519:	68 08 26 80 00       	push   $0x802608
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  80177a:	68 74 26 80 00       	push   $0x802674
  80177f:	68 7b 26 80 00       	push   $0x80267b
  801784:	6a 7c                	push   $0x7c
  801786:	68 90 26 80 00       	push   $0x802690
  80178b:	e8 c6 05 00 00       	call   801d56 <_panic>
	assert(r <= PGSIZE);
  801790:	3d 00 10 00 00       	cmp    $0x1000,%eax
  801795:	7e 16                	jle    8017ad <devfile_read+0x65>
  801797:	68 9b 26 80 00       	push   $0x80269b
  80179c:	68 7b 26 80 00       	push   $0x80267b
  8017a1:	6a 7d                	push   $0x7d
  8017a3:	68 90 26 80 00       	push   $0x802690
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801886:	68 a7 26 80 00       	push   $0x8026a7
  80188b:	53                   	push   %ebx
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  80193f:	50                   	push   %eax
  801940:	56                   	push   %esi
  801941:	68 ae 26 80 00       	push   $0x8026ae
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801be3:	68 c6 26 80 00       	push   $0x8026c6
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801d72:	56                   	push   %esi
  801d73:	50                   	push   %eax
  801d74:	68 d4 26 80 00       	push   $0x8026d4
  ...
  801d85:	e8 89 e3 ff ff       	call   800113 <vcprintf>
	cprintf("\n");
  801d8a:	c7 04 24 3c 22 80 00 	movl   $0x80223c,(%esp)
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  801dc1:	79 12                	jns    801dd5 <set_pgfault_handler+0x39>
			panic("%e\n", r);
  801dc3:	50                   	push   %eax
  801dc4:	68 f8 26 80 00       	push   $0x8026f8
  801dc9:	6a 23                	push   $0x23
  801dcb:	68 fc 26 80 00       	push   $0x8026fc
  ...
  801df1:	79 12                	jns    801e05 <set_pgfault_handler+0x69>
		panic("%e\n", r);
  801df3:	50                   	push   %eax
  801df4:	68 f8 26 80 00       	push   $0x8026f8
  801df9:	6a 2c                	push   $0x2c
  801dfb:	68 fc 26 80 00       	push   $0x8026fc
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801ede:	50                   	push   %eax
  801edf:	68 0a 27 80 00       	push   $0x80270a
  801ee4:	6a 47                	push   $0x47
  801ee6:	68 18 27 80 00       	push   $0x802718
