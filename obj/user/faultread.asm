	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800212:	0f be 80 08 22 80 00 	movsbl 0x802208(%eax),%eax
  800219:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80030e:	ff 24 85 40 23 80 00 	jmp    *0x802340(,%eax,4)
  ...
  8003d2:	8b 14 85 a0 24 80 00 	mov    0x8024a0(,%eax,4),%edx
  8003d9:	85 d2                	test   %edx,%edx
  8003db:	75 18                	jne    8003f5 <vprintfmt+0x15a>
				printfmt(putch, putdat, "error %d", err);
  8003dd:	50                   	push   %eax
  8003de:	68 20 22 80 00       	push   $0x802220
  8003e3:	53                   	push   %ebx
  8003e4:	56                   	push   %esi
  ...
  8003f5:	52                   	push   %edx
  8003f6:	68 4d 26 80 00       	push   $0x80264d
  8003fb:	53                   	push   %ebx
  8003fc:	56                   	push   %esi
  ...
  80041a:	b8 19 22 80 00       	mov    $0x802219,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800a95:	68 ff 24 80 00       	push   $0x8024ff
  800a9a:	6a 23                	push   $0x23
  800a9c:	68 1c 25 80 00       	push   $0x80251c
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b16:	68 ff 24 80 00       	push   $0x8024ff
  800b1b:	6a 23                	push   $0x23
  800b1d:	68 1c 25 80 00       	push   $0x80251c
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800b9a:	68 ff 24 80 00       	push   $0x8024ff
  800b9f:	6a 23                	push   $0x23
  800ba1:	68 1c 25 80 00       	push   $0x80251c
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800bdc:	68 ff 24 80 00       	push   $0x8024ff
  800be1:	6a 23                	push   $0x23
  800be3:	68 1c 25 80 00       	push   $0x80251c
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800c1e:	68 ff 24 80 00       	push   $0x8024ff
  800c23:	6a 23                	push   $0x23
  800c25:	68 1c 25 80 00       	push   $0x80251c
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800c60:	68 ff 24 80 00       	push   $0x8024ff
  800c65:	6a 23                	push   $0x23
  800c67:	68 1c 25 80 00       	push   $0x80251c
...
sys_ipc_recv(void *dstva)
{
  ...
  800cc4:	68 ff 24 80 00       	push   $0x8024ff
  800cc9:	6a 23                	push   $0x23
  800ccb:	68 1c 25 80 00       	push   $0x80251c
...
pgfault(struct UTrapframe *utf)
{
  ...
  800d43:	68 2a 25 80 00       	push   $0x80252a
  800d48:	6a 1e                	push   $0x1e
  800d4a:	68 3a 25 80 00       	push   $0x80253a
  ...
  800d6c:	50                   	push   %eax
  800d6d:	68 45 25 80 00       	push   $0x802545
  800d72:	6a 2c                	push   $0x2c
  800d74:	68 3a 25 80 00       	push   $0x80253a
  ...
  800db2:	79 12                	jns    800dc6 <pgfault+0xa9>
		panic("sys page alloc failed %e", r);
  800db4:	50                   	push   %eax
  800db5:	68 45 25 80 00       	push   $0x802545
  800dba:	6a 33                	push   $0x33
  800dbc:	68 3a 25 80 00       	push   $0x80253a
  ...
  800dda:	79 12                	jns    800dee <pgfault+0xd1>
		panic("sys page alloc failed %e", r);
  800ddc:	50                   	push   %eax
  800ddd:	68 45 25 80 00       	push   $0x802545
  800de2:	6a 37                	push   $0x37
  800de4:	68 3a 25 80 00       	push   $0x80253a
...
sys_exofork(void)
{
  ...
  800e1a:	68 5e 25 80 00       	push   $0x80255e
  800e1f:	68 84 00 00 00       	push   $0x84
  800e24:	68 3a 25 80 00       	push   $0x80253a
  ...
  800e97:	0f 84 e7 00 00 00    	je     800f84 <fork+0x191>
{
  ...
  800ed6:	68 6c 25 80 00       	push   $0x80256c
  800edb:	6a 54                	push   $0x54
  800edd:	68 3a 25 80 00       	push   $0x80253a
  ...
  800f1b:	68 6c 25 80 00       	push   $0x80256c
  800f20:	6a 5b                	push   $0x5b
  800f22:	68 3a 25 80 00       	push   $0x80253a
  ...
  800f49:	68 6c 25 80 00       	push   $0x80256c
  800f4e:	6a 5f                	push   $0x5f
  800f50:	68 3a 25 80 00       	push   $0x80253a
  ...
  800f73:	68 6c 25 80 00       	push   $0x80256c
  800f78:	6a 64                	push   $0x64
  800f7a:	68 3a 25 80 00       	push   $0x80253a
...
thread_create(void (*func)())
{
  ...
  800fe1:	53                   	push   %ebx
  800fe2:	68 84 25 80 00       	push   $0x802584
  ...
  800ffd:	53                   	push   %ebx
  800ffe:	68 84 25 80 00       	push   $0x802584
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  8010e6:	ba 24 26 80 00       	mov    $0x802624,%edx
	int i;
	for (i = 0; devtab[i]; i++)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  801111:	51                   	push   %ecx
  801112:	50                   	push   %eax
  801113:	68 a8 25 80 00       	push   $0x8025a8
...
read(int fdnum, void *buf, size_t n)
{
  ...
  80133b:	53                   	push   %ebx
  80133c:	50                   	push   %eax
  80133d:	68 e9 25 80 00       	push   $0x8025e9
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  801410:	53                   	push   %ebx
  801411:	50                   	push   %eax
  801412:	68 05 26 80 00       	push   $0x802605
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8014c5:	53                   	push   %ebx
  8014c6:	50                   	push   %eax
  8014c7:	68 c8 25 80 00       	push   $0x8025c8
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  801728:	68 34 26 80 00       	push   $0x802634
  80172d:	68 3b 26 80 00       	push   $0x80263b
  801732:	6a 7c                	push   $0x7c
  801734:	68 50 26 80 00       	push   $0x802650
  801739:	e8 c6 05 00 00       	call   801d04 <_panic>
	assert(r <= PGSIZE);
  80173e:	3d 00 10 00 00       	cmp    $0x1000,%eax
  801743:	7e 16                	jle    80175b <devfile_read+0x65>
  801745:	68 5b 26 80 00       	push   $0x80265b
  80174a:	68 3b 26 80 00       	push   $0x80263b
  80174f:	6a 7d                	push   $0x7d
  801751:	68 50 26 80 00       	push   $0x802650
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801834:	68 67 26 80 00       	push   $0x802667
  801839:	53                   	push   %ebx
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  8018ed:	50                   	push   %eax
  8018ee:	56                   	push   %esi
  8018ef:	68 6e 26 80 00       	push   $0x80266e
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801b91:	68 86 26 80 00       	push   $0x802686
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801d20:	56                   	push   %esi
  801d21:	50                   	push   %eax
  801d22:	68 94 26 80 00       	push   $0x802694
  ...
  801d33:	e8 db e3 ff ff       	call   800113 <vcprintf>
	cprintf("\n");
  801d38:	c7 04 24 fc 21 80 00 	movl   $0x8021fc,(%esp)
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  801d6f:	79 12                	jns    801d83 <set_pgfault_handler+0x39>
			panic("%e\n", r);
  801d71:	50                   	push   %eax
  801d72:	68 b8 26 80 00       	push   $0x8026b8
  801d77:	6a 23                	push   $0x23
  801d79:	68 bc 26 80 00       	push   $0x8026bc
  ...
  801d9f:	79 12                	jns    801db3 <set_pgfault_handler+0x69>
		panic("%e\n", r);
  801da1:	50                   	push   %eax
  801da2:	68 b8 26 80 00       	push   $0x8026b8
  801da7:	6a 2c                	push   $0x2c
  801da9:	68 bc 26 80 00       	push   $0x8026bc
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801e8c:	50                   	push   %eax
  801e8d:	68 ca 26 80 00       	push   $0x8026ca
  801e92:	6a 47                	push   $0x47
  801e94:	68 d8 26 80 00       	push   $0x8026d8
