...
sys_env_destroy(envid_t envid)
{
  ...
  800132:	68 2a 22 80 00       	push   $0x80222a
  800137:	6a 23                	push   $0x23
  800139:	68 47 22 80 00       	push   $0x802247
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8001b3:	68 2a 22 80 00       	push   $0x80222a
  8001b8:	6a 23                	push   $0x23
  8001ba:	68 47 22 80 00       	push   $0x802247
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001f5:	68 2a 22 80 00       	push   $0x80222a
  8001fa:	6a 23                	push   $0x23
  8001fc:	68 47 22 80 00       	push   $0x802247
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800237:	68 2a 22 80 00       	push   $0x80222a
  80023c:	6a 23                	push   $0x23
  80023e:	68 47 22 80 00       	push   $0x802247
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800279:	68 2a 22 80 00       	push   $0x80222a
  80027e:	6a 23                	push   $0x23
  800280:	68 47 22 80 00       	push   $0x802247
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  8002bb:	68 2a 22 80 00       	push   $0x80222a
  8002c0:	6a 23                	push   $0x23
  8002c2:	68 47 22 80 00       	push   $0x802247
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8002fd:	68 2a 22 80 00       	push   $0x80222a
  800302:	6a 23                	push   $0x23
  800304:	68 47 22 80 00       	push   $0x802247
...
sys_ipc_recv(void *dstva)
{
  ...
  800361:	68 2a 22 80 00       	push   $0x80222a
  800366:	6a 23                	push   $0x23
  800368:	68 47 22 80 00       	push   $0x802247
...
pgfault(struct UTrapframe *utf)
{
  ...
  800400:	68 55 22 80 00       	push   $0x802255
  800405:	6a 1e                	push   $0x1e
  800407:	68 65 22 80 00       	push   $0x802265
  ...
  800429:	50                   	push   %eax
  80042a:	68 70 22 80 00       	push   $0x802270
  80042f:	6a 2c                	push   $0x2c
  800431:	68 65 22 80 00       	push   $0x802265
  ...
  80046f:	79 12                	jns    800483 <pgfault+0xa9>
		panic("sys page alloc failed %e", r);
  800471:	50                   	push   %eax
  800472:	68 70 22 80 00       	push   $0x802270
  800477:	6a 33                	push   $0x33
  800479:	68 65 22 80 00       	push   $0x802265
  ...
  800497:	79 12                	jns    8004ab <pgfault+0xd1>
		panic("sys page alloc failed %e", r);
  800499:	50                   	push   %eax
  80049a:	68 70 22 80 00       	push   $0x802270
  80049f:	6a 37                	push   $0x37
  8004a1:	68 65 22 80 00       	push   $0x802265
...
sys_exofork(void)
{
  ...
  8004d7:	68 89 22 80 00       	push   $0x802289
  8004dc:	68 84 00 00 00       	push   $0x84
  8004e1:	68 65 22 80 00       	push   $0x802265
  ...
  800554:	0f 84 e7 00 00 00    	je     800641 <fork+0x191>
{
  ...
  800593:	68 97 22 80 00       	push   $0x802297
  800598:	6a 54                	push   $0x54
  80059a:	68 65 22 80 00       	push   $0x802265
  ...
  8005d8:	68 97 22 80 00       	push   $0x802297
  8005dd:	6a 5b                	push   $0x5b
  8005df:	68 65 22 80 00       	push   $0x802265
  ...
  800630:	68 97 22 80 00       	push   $0x802297
  800635:	6a 64                	push   $0x64
  800637:	68 65 22 80 00       	push   $0x802265
...
thread_create(void (*func)())
{
  ...
  80069e:	53                   	push   %ebx
  80069f:	68 b0 22 80 00       	push   $0x8022b0
  ...
  8006ba:	53                   	push   %ebx
  8006bb:	68 b0 22 80 00       	push   $0x8022b0
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  8007c9:	ba 50 23 80 00       	mov    $0x802350,%edx
	int i;
	for (i = 0; devtab[i]; i++)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  8007f7:	51                   	push   %ecx
  8007f8:	50                   	push   %eax
  8007f9:	68 d4 22 80 00       	push   $0x8022d4
...
read(int fdnum, void *buf, size_t n)
{
  ...
  800a24:	53                   	push   %ebx
  800a25:	50                   	push   %eax
  800a26:	68 15 23 80 00       	push   $0x802315
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  800afc:	53                   	push   %ebx
  800afd:	50                   	push   %eax
  800afe:	68 31 23 80 00       	push   $0x802331
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  800bb4:	53                   	push   %ebx
  800bb5:	50                   	push   %eax
  800bb6:	68 f4 22 80 00       	push   $0x8022f4
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  800e17:	68 60 23 80 00       	push   $0x802360
  800e1c:	68 67 23 80 00       	push   $0x802367
  800e21:	6a 7c                	push   $0x7c
  800e23:	68 7c 23 80 00       	push   $0x80237c
  800e28:	e8 c6 05 00 00       	call   8013f3 <_panic>
	assert(r <= PGSIZE);
  800e2d:	3d 00 10 00 00       	cmp    $0x1000,%eax
  800e32:	7e 16                	jle    800e4a <devfile_read+0x65>
  800e34:	68 87 23 80 00       	push   $0x802387
  800e39:	68 67 23 80 00       	push   $0x802367
  800e3e:	6a 7d                	push   $0x7d
  800e40:	68 7c 23 80 00       	push   $0x80237c
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800f23:	68 93 23 80 00       	push   $0x802393
  800f28:	53                   	push   %ebx
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  800fdc:	50                   	push   %eax
  800fdd:	56                   	push   %esi
  800fde:	68 9a 23 80 00       	push   $0x80239a
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801280:	68 b2 23 80 00       	push   $0x8023b2
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80140f:	56                   	push   %esi
  801410:	50                   	push   %eax
  801411:	68 c0 23 80 00       	push   $0x8023c0
  ...
  801422:	e8 54 00 00 00       	call   80147b <vcprintf>
	cprintf("\n");
  801427:	c7 04 24 ab 23 80 00 	movl   $0x8023ab,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80157a:	0f be 80 e3 23 80 00 	movsbl 0x8023e3(%eax),%eax
  801581:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  801745:	50                   	push   %eax
  801746:	68 fb 23 80 00       	push   $0x8023fb
  80174b:	53                   	push   %ebx
  80174c:	56                   	push   %esi
  ...
  80175d:	52                   	push   %edx
  80175e:	68 79 23 80 00       	push   $0x802379
  801763:	53                   	push   %ebx
  801764:	56                   	push   %esi
  ...
  801782:	b8 f4 23 80 00       	mov    $0x8023f4,%eax
