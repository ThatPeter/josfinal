...
umain(int argc, char **argv)
{
  ...
  800040:	e8 24 0a 00 00       	call   800a69 <sys_cputs>
}
...
libmain(int argc, char **argv)
{
  ...
  800067:	50                   	push   %eax
  800068:	68 60 1e 80 00       	push   $0x801e60
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80024b:	0f be 80 89 1e 80 00 	movsbl 0x801e89(%eax),%eax
  800252:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800347:	ff 24 85 c0 1f 80 00 	jmp    *0x801fc0(,%eax,4)
  ...
  80040b:	8b 14 85 20 21 80 00 	mov    0x802120(,%eax,4),%edx
  800412:	85 d2                	test   %edx,%edx
  800414:	75 18                	jne    80042e <vprintfmt+0x15a>
				printfmt(putch, putdat, "error %d", err);
  800416:	50                   	push   %eax
  800417:	68 a1 1e 80 00       	push   $0x801ea1
  80041c:	53                   	push   %ebx
  80041d:	56                   	push   %esi
  ...
  80042e:	52                   	push   %edx
  80042f:	68 51 22 80 00       	push   $0x802251
  800434:	53                   	push   %ebx
  800435:	56                   	push   %esi
  ...
  800453:	b8 9a 1e 80 00       	mov    $0x801e9a,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800ace:	68 7f 21 80 00       	push   $0x80217f
  800ad3:	6a 23                	push   $0x23
  800ad5:	68 9c 21 80 00       	push   $0x80219c
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b4f:	68 7f 21 80 00       	push   $0x80217f
  800b54:	6a 23                	push   $0x23
  800b56:	68 9c 21 80 00       	push   $0x80219c
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800b91:	68 7f 21 80 00       	push   $0x80217f
  800b96:	6a 23                	push   $0x23
  800b98:	68 9c 21 80 00       	push   $0x80219c
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800bd3:	68 7f 21 80 00       	push   $0x80217f
  800bd8:	6a 23                	push   $0x23
  800bda:	68 9c 21 80 00       	push   $0x80219c
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c15:	68 7f 21 80 00       	push   $0x80217f
  800c1a:	6a 23                	push   $0x23
  800c1c:	68 9c 21 80 00       	push   $0x80219c
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800c57:	68 7f 21 80 00       	push   $0x80217f
  800c5c:	6a 23                	push   $0x23
  800c5e:	68 9c 21 80 00       	push   $0x80219c
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800c99:	68 7f 21 80 00       	push   $0x80217f
  800c9e:	6a 23                	push   $0x23
  800ca0:	68 9c 21 80 00       	push   $0x80219c
...
sys_ipc_recv(void *dstva)
{
  ...
  800cfd:	68 7f 21 80 00       	push   $0x80217f
  800d02:	6a 23                	push   $0x23
  800d04:	68 9c 21 80 00       	push   $0x80219c
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800e0b:	ba 28 22 80 00       	mov    $0x802228,%edx
	int i;
	for (i = 0; devtab[i]; i++)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800e36:	51                   	push   %ecx
  800e37:	50                   	push   %eax
  800e38:	68 ac 21 80 00       	push   $0x8021ac
...
read(int fdnum, void *buf, size_t n)
{
  ...
  801060:	53                   	push   %ebx
  801061:	50                   	push   %eax
  801062:	68 ed 21 80 00       	push   $0x8021ed
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  801135:	53                   	push   %ebx
  801136:	50                   	push   %eax
  801137:	68 09 22 80 00       	push   $0x802209
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8011ea:	53                   	push   %ebx
  8011eb:	50                   	push   %eax
  8011ec:	68 cc 21 80 00       	push   $0x8021cc
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  80144d:	68 38 22 80 00       	push   $0x802238
  801452:	68 3f 22 80 00       	push   $0x80223f
  801457:	6a 7c                	push   $0x7c
  801459:	68 54 22 80 00       	push   $0x802254
  ...
  80146f:	68 3f 22 80 00       	push   $0x80223f
  801474:	6a 7d                	push   $0x7d
  801476:	68 54 22 80 00       	push   $0x802254
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801559:	68 6b 22 80 00       	push   $0x80226b
  80155e:	53                   	push   %ebx
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  801609:	50                   	push   %eax
  80160a:	56                   	push   %esi
  80160b:	68 72 22 80 00       	push   $0x802272
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8018ad:	68 8a 22 80 00       	push   $0x80228a
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801a3c:	56                   	push   %esi
  801a3d:	50                   	push   %eax
  801a3e:	68 98 22 80 00       	push   $0x802298
  ...
  801a4f:	e8 f8 e6 ff ff       	call   80014c <vcprintf>
	cprintf("\n");
  801a54:	c7 04 24 83 22 80 00 	movl   $0x802283,(%esp)
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801b13:	50                   	push   %eax
  801b14:	68 bc 22 80 00       	push   $0x8022bc
  801b19:	6a 47                	push   $0x47
  801b1b:	68 ca 22 80 00       	push   $0x8022ca
